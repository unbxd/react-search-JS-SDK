...
const ListProductCard = ({ itemData, productMap, showVariants, productVariantMap }) => {
    ...
    return (<div className='UNX-product-card-container' data-uniqueid={uniqueId}>
        <a href={itemData.productUrl} className={`UNX-product-card UNX-list-card`} data-uniqueid={uniqueId}>
